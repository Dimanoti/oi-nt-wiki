...
**合数**是大于 $1$ 且不是[素数](/oi-nt-wiki/素数)的自然数。例如：
...
由[算术基本定理](/oi-nt-wiki/算术基本定理)，任意大于 $1$ 的自然数都可以唯一地分解为若干个素数的乘积，其中不考虑素因子的排列顺序。
...
对于大整数的质因数分解，详见[Pollard-Rho算法](/oi-nt-wiki/Pollard-Rho)。